                        ...
                        if (lower.contains("cinesrc.st") && lower.contains(".css")) {
                            try {
                                ...
                                if (in != null && statusCode < 400) {
                                    ...
                                    in.close();
                                    String extraCss = "\n"
                                        + "/* Hide native CineSrc episode selector button */\n"
                                        ...
                                        + "\n"
                                        + "/* Hide native CineSrc fullscreen button */\n"
                                        + "button[aria-label*='full' i],\n"
                                        + "button[aria-label*='Fullscreen' i],\n"
                                        + "button[title*='full' i],\n"
                                        + "button[data-slot='fullscreen-button'],\n"
                                        + "button[data-slot='media-fullscreen-button'],\n"
                                        + "[data-media-fullscreen-button],\n"
                                        + "media-fullscreen-button,\n"
                                        + "button:has(svg [d*='M3 3h6v2H5v4H3V3']),\n"
                                        + "button:has(svg [d*='M7 14H5v5h5v-2H7v-3']),\n"
                                        + "button:has(svg [d*='M3 3']),\n"
                                        + "button:has(svg.lucide-maximize),\n"
                                        + "button:has(svg.lucide-maximize-2),\n"
                                        + "button:has(svg.lucide-minimize),\n"
                                        + "button:has(svg.lucide-minimize-2) {\n"
                                     ...
                                     if (isPhone()) {
                                         extraCss += "\n"
                                             ...
                                             + "  .isolate:has(>.notflix-settings-menu),\n"
                                             + "  .isolate:has([role='dialog']),\n"
                                             + "  div:has(>[role='dialog']) {\n"
                                             ...
                                             + "    right: 0 !important;\n"
                                             + "  }\n"
                                             + "  [role='dialog'], [data-slot='dialog-content'], [data-slot='drawer-content'], [data-slot='sheet-content'], [class*='rounded-t-2xl'], [class*='rounded-t-3xl'], .notflix-settings-menu {\n"
                                             + "    width: 100vw !important;\n"
                                             + "    max-width: 100vw !important;\n"
                                             + "    left: 0 !important;\n"
                                             + "    right: 0 !important;\n"
                                             ...
                                             + "  }\n"
                                             + "  [role='dialog'] [class*='overflow-y-auto'], [class*='rounded-t-2xl'] [class*='overflow-y-auto'], .notflix-settings-body {\n"
                                             + "    max-height: calc(100vh - 165px) !important;\n"
                                             + "    overscroll-behavior: contain !important;\n"
                                             + "  }\n"
                                             + "  /* Override CineSrc Base UI Popper positioning & w-80 width for Server Menu */\n"
                                             + "  div.isolate[role='presentation']:has(>[data-slot='dropdown-menu-content']),\n"
                                             + "  div.isolate[role='presentation']:has(>[role='menu']),\n"
                                             + "  div.isolate:has(>[data-slot='dropdown-menu-content']),\n"
                                             + "  div.isolate:has(>[role='menu']) {\n"
                                             + "    left: 0 !important;\n"
                                             + "    right: 0 !important;\n"
                                             ...
                                             + "  [role='menu'].ring-1,\n"
                                             + "  div.isolate[role='presentation'] > [role='menu'] {\n"
