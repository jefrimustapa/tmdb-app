                            ...
                            try {
                                ...
                                if (in != null && statusCode < 400) {
                                    ...
                                    String extraCss = "\n"
                                        ...
                                        + "button[aria-label*='full' i], button[aria-label*='Fullscreen' i], button[data-slot='fullscreen-button'], [data-media-fullscreen-button], button:has(svg [d*='M3 3h6v2H5v4H3V3']), button:has(svg [d*='M7 14H5v5h5v-2H7v-3']) {\n"
