...
export const APP_BUILD_NUMBER = '20260905-1232';
export const APP_VERSION_FULL = '1.2.0-dev.jefri.feat-series-page-fil.20260905-1232';
export const APP_BUILD_CHANNEL: BuildChannel = 'dev';
export const APP_BUILD_DEV = 'jefri';
export const APP_BRANCH = 'feat-series-page-fil';
export const APP_CHANGELOG = `* feat(movies): add sticky freezing MovieFilterBar with multi-select and scrollable chips
