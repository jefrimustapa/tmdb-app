...
export const APP_BUILD_NUMBER = '20260831-1354';
export const APP_VERSION_FULL = '1.2.0-dev.jefri.feat-restructure-set.20260831-1354';
export const APP_BUILD_CHANNEL: BuildChannel = 'dev';
export const APP_BUILD_DEV = 'jefri';
export const APP_BRANCH = 'feat-restructure-set';
export const APP_CHANGELOG = `* fix(tv-nav): enforce same-row boundary on Left key so single buttons return to active Category
