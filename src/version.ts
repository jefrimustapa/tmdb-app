...
export const APP_BUILD_NUMBER = '20260919-0600';
export const APP_VERSION_FULL = '1.2.0-dev.jefri.feat-add-provider-te.20260919-0600';
export const APP_BUILD_CHANNEL: BuildChannel = 'dev';
export const APP_BUILD_DEV = 'jefri';
export const APP_BRANCH = 'feat-add-provider-te';
export const APP_CHANGELOG = `* feat(telegram): remove url textbox, auto-ping on settings open, and fix watch provider selection
