...
export const APP_BUILD_NUMBER = '20260925-1113';
export const APP_VERSION_FULL = '1.2.0-dev.jefri.feat-voice-search.20260925-1113';
export const APP_BUILD_CHANNEL: BuildChannel = 'dev';
export const APP_BUILD_DEV = 'jefri';
export const APP_BRANCH = 'feat-voice-search';
export const APP_CHANGELOG = `* fix(player): prevent router OOM by avoiding forced transcoding on standard MKVs with audio fallback (#146)
