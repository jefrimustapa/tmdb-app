    ...
    <div className="min-h-screen pb-16 bg-hbo-dark">
      ...
      {history.length > 0 && (
        <section className="mb-6 w-full" data-content-rail="true">
          ...
          <div className="flex items-center gap-3.5 overflow-x-auto no-scrollbar py-4 pl-4 sm:pl-8 pr-6 sm:pr-8 -my-2 snap-x snap-proximity scroll-pl-4 sm:scroll-pl-8 touch-pan-x">
            {history.map((hist) => (
              <MediaCard
