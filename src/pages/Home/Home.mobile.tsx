...
export const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-16 bg-hbo-dark">
      ...
      {history.length > 0 && (
        <section className="mb-6 px-4 sm:px-8 max-w-7xl mx-auto" data-content-rail="true">
          ...
          <div className="flex items-center gap-3.5 overflow-x-auto no-scrollbar py-1.5 pl-2 pr-6 scroll-smooth transform-gpu">
            {history.map((hist) => (
              <MediaCard
