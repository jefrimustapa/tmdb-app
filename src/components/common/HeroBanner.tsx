    ...
    >
      ...
      >
        {displayItems.map((featured, idx) => {
          ...
          return (
            <div key={featured.id} className="min-w-full w-full h-full relative flex-shrink-0">
              ...
              <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-8 flex flex-col justify-end pb-12 sm:pb-16 max-w-2xl lg:max-w-3xl">
                ...
                {/* Title */}
                <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black font-display text-white tracking-tight leading-tight mb-2.5 drop-shadow-lg">
                  {title}
                </h1>

                {/* Overview */}
                <p className="text-sm sm:text-base text-gray-300 line-clamp-3 mb-5 max-w-2xl leading-relaxed drop-shadow-md">
                  {featured.overview}
                </p>
                ...
                <div className="flex flex-col gap-2.5 w-fit">
                  <Link
                    ...
                    className="flex items-center gap-2.5 px-6 sm:px-8 py-3 rounded-xl bg-gradient-to-r from-hbo-purple to-hbo-cyan text-white font-bold text-sm sm:text-base shadow-hbo-glow hover:scale-105 transition-all tv-focus-target"
                  >
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-white/15 hover:bg-white/25 text-white font-semibold text-sm sm:text-base backdrop-blur-md border border-white/20 transition-all hover:scale-105 tv-focus-target"
                  >
